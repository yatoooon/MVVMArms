...
import com.common.web.entity.*
import com.common.web.entity.ToolBarEntity.BtnLeftEntity
import com.common.web.entity.ToolBarEntity.BtnmoreEntity
import com.common.web.ui.activity.TabPageActivity
import com.common.web.ui.activity.WebPageActivity
import com.common.web.ui.fragment.WebPageFrgment
import com.common.web.utils.JsApiHelper
import com.common.web.view.BaseDWebView
import com.common.web.view.CompletionHandler
...
class JsApi {
    ...
    fun init(fragment: WebPageFrgment?, dWebView: BaseDWebView?) {
        ...
        if (activity is WebPageActivity) {
            val webPageActivity = activity as WebPageActivity
            webPageActivity.binding.layoutToolbar.let {
                webframeToolbar = it.webframeToolbar
                ivWebframeMore = it.ivWebframeMore
                ivWebframeBack = it.ivWebframeBack
                ivRightImage = it.ivRightImage
                tvWebframeRightText = it.tvWebframeRightText
            }
