...
public final class SlantedTextView extends View {
    ...
    public SlantedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.res_SlantedTextView);

        setText(array.getString(R.styleable.res_SlantedTextView_android_text));
        setTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.res_SlantedTextView_android_textSize, (int) getResources().getDimension(R.dimen.res_sp_12)));
        setTextColor(array.getColor(R.styleable.res_SlantedTextView_android_textColor, Color.WHITE));
        setTextStyle(Typeface.defaultFromStyle(array.getInt(R.styleable.res_SlantedTextView_android_textStyle, Typeface.NORMAL)));
        setGravity(array.getInt(R.styleable.res_SlantedTextView_android_gravity, Gravity.END));
        setColorBackground(array.getColor(R.styleable.res_SlantedTextView_android_colorBackground, getAccentColor()));
        setTriangle(array.getBoolean(R.styleable.res_SlantedTextView_res_triangle, false));
