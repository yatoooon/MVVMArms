...
import com.basis.common.action.ActivityAction;
import com.basis.common.dialog.BaseDialog;
import com.basis.common.dialog.InputDialog;
import com.basis.common.dialog.MessageDialog;
import com.basis.common.dialog.TipsDialog;
import com.basis.common.layout.NestedScrollWebView;
import com.basis.common.utils.PermissionCallback;
...
public final class BrowserView extends NestedScrollWebView
    ...
    public static class BrowserViewClient extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            ...
            new MessageDialog.Builder(context)
                    .setMessage(R.string.res_common_web_ssl_error_title)
                    .setConfirm(R.string.res_common_web_ssl_error_allow)
                    .setCancel(R.string.res_common_web_ssl_error_reject)
                    .setCancelable(false)
        ...
        protected void dialing(WebView view, String url) {
            ...
            new MessageDialog.Builder(context)
                    .setMessage(String.format(view.getResources().getString(R.string.res_common_web_call_phone_title), url.replace("tel:", "")))
                    .setConfirm(R.string.res_common_web_call_phone_allow)
                    .setCancel(R.string.res_common_web_call_phone_reject)
                    .setCancelable(false)
                    .setListener(dialog -> {
    ...
    public static class BrowserChromeClient extends WebChromeClient {
        ...
        public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
            ...
            new MessageDialog.Builder(activity)
                    .setMessage(R.string.res_common_web_location_permission_title)
                    .setConfirm(R.string.res_common_web_location_permission_allow)
                    .setCancel(R.string.res_common_web_location_permission_reject)
                    .setCancelable(false)
                    .setListener(new MessageDialog.OnListener() {
