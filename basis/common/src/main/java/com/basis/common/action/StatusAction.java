package com.basis.common.action;
...
public interface StatusAction {
    ...
    default void showEmpty() {
        showLayout(R.drawable.res_status_empty_ic, R.string.res_status_layout_no_data, null);
    }
    ...
    default void showError(StatusLayout.OnRetryListener listener) {
        ...
        showLayout(R.drawable.res_status_error_ic, R.string.res_status_layout_error_request, listener);
    }
