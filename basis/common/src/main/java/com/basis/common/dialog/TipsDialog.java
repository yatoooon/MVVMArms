...
public final class TipsDialog {
    ...
    public final static int ICON_FINISH = R.drawable.res_tips_finish_ic;
    public final static int ICON_ERROR = R.drawable.res_tips_error_ic;
    public final static int ICON_WARNING = R.drawable.res_tips_warning_ic;
