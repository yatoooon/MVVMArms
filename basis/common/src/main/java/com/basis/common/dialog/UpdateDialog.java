    ...
    public static final class Builder
        ...
        private void downloadApk() {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                NotificationChannel channel = new NotificationChannel(getString(R.string.res_update_notification_channel_id), getString(R.string.res_update_notification_channel_name), NotificationManager.IMPORTANCE_LOW);
