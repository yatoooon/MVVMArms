...
public class CheckNetAspect {
     ...
     * 方法切入点
     */
    @Pointcut("execution(@com.arms.common.aop.CheckNet * *(..))")
    public void method() {}
    ...
    public void aroundJoinPoint(ProceedingJoinPoint joinPoint, CheckNet checkNet) throws Throwable {
        Application application = CommonApp.getApp();
        if (application != null) {
            ...
            if (manager != null) {
                ...
                if (info == null || !info.isConnected()) {
                    ToastUtils.show(R.string.res_common_network_hint);
                    return;
                }
            }
        }
